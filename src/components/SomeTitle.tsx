...
import Frames from './Themes/Frames';
 ...
 const SomeTitle = () => {
  ...
  return (
    <div data-scroll-section className='flex items-center justify-center relative w-full h-[120px] lg:h-[150px] '>
      ...
      {/* <p className='text-bg hidden sm:block font-bold top-[-10%] lg:left-[30%] md:left-[45%] mid:left-[55%] left-[60%] p-2 z-10 rounded-2xl absolute bg-active '>{greeting}!</p> */}
        <h3 className='text-text px-2    uppercase text-[1.5rem] absolute left-[5%]  lg:text-[3.2rem] font-bold'>SOME ANIMATIONS.</h3>
