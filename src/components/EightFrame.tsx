...
import Frames from './Themes/Frames'
 ...
 const EightFrame = () => {
  return (
   <div data-scroll-section className='flex items-center justify-center w-full h-[250px]'>
        <Frames className='w-[3%] xs:w-[5%] mid:w-[7%] md:w-[5%] lg:w-[3%]'/>
        <div className='w-[94%] lg:w-[94%] xs:w-[90%] flex mid:w-[86%] md:w-[90%]  flex-col items-center justify-center gap-4 p-4 border-r-[0.5px] border-b-[0.5px] border-border h-full text-center'>
