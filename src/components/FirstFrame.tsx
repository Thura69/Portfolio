...
const FirstFrame = () => {
  ...
  return (
      ...
      <div className='w-full flex fixed items-center  bg-bg z-[100]   top-0 left-0 right-0  justify-center h-[50px] xs:h-[50px] lg:h-[60px] mid:h-[55px]'> <Frames className='w-[3%] xs:w-[5%] mid:w-[7%] md:w-[5%] lg:w-[3.05%]'/>
        <div className='w-[47%]   flex items-center justify-start px-3  font-bold h-full  border-r-[0.5px]  border-b-[0.5px] border-border xs:w-[45%] mid:w-[43%] md:w-[45%] lg:w-[34.15%]' >
        {/* <p className=' text-text text-[18px]   absolute '>Full Stack Developer</p> */}
         <AnimatedTextWord transition={{staggerChildren:0.3,delayChildren:0.050 * 10}} text='The Developer' classname='text-text uppercase text-[18px]    absolute '/>
        </div>
