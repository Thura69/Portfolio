...
const styles = {
 ...
 const SomeAnimation = () => {
  return (
    <div data-scroll-section className='flex items-center justify-center  w-full h-[1300px] xs:h-[960px] sm:h-[900px] mid:h-[1000px] lg:h-[560px] md:h-[950px]'>
    ...
    {/* <div data-scroll-sticky className='md:p-5 lg:p-8 2xl:p-10 bg-bg lg:w-[50.1%] order-1 md:w-[50%] xl:w-[33.1%]   border-text  md:flex items-center justify-center md:justify-start bg-text'>
      <p className='text-bg text-[2.2rem]  font-bold'>Infinite rotation</p>
       ...
       <Image className='mx-auto' src={Profile} alt="hello"/>
        ...
        <div className=' md:flex p-4 md:p-5 md:w-[100%] relative lg:p-10  lg:w-[60%] xl:w-[40.6%] border-b-[0.5px]  flex-col md:border-r-[0.5px] border-border items-start  lg:text-[19.4px] bg-bg h-[460px] lg:h-auto'>
      <div className='border-border mx-auto relative  border-[0.5px]   rounded-xl'>
        ...
        <Image className=' bottom-[30px] absolute left-[20px] w-[330px] mt-[20px]' src={About} alt="hello" />
        </div>
