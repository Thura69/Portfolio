...
const styles = {
 ...
 const SomeAnimation = () => {
  return (
    <div data-scroll-section className='flex items-center justify-center  w-full h-[950px] xs:h-[960px] sm:h-[900px] mid:h-[1000px] lg:h-[560px] md:h-[950px]'>
    ...
    {/* <div data-scroll-sticky className='md:p-5 lg:p-8 2xl:p-10 bg-bg lg:w-[50.1%] order-1 md:w-[50%] xl:w-[33.1%]   border-text  md:flex items-center justify-center md:justify-start bg-text'>
      <p className='text-bg text-[2.2rem]  font-bold'>Infinite rotation</p>
       ...
       <Image className='mx-auto' src={Profile} alt="hello"/>
        ...
        <div className=' md:flex md:p-5 md:w-[100%] relative lg:p-10  lg:w-[60%] xl:w-[40.6%]  flex-col md:border-r-[0.5px] border-border items-start  lg:text-[19.4px] bg-bg'>
      <div className='border-border mx-auto relative  border-[0.5px]  h-[380px] rounded-xl'>
         <Image className=' mx-auto w-auto p-3  rounded-xl   h-[380px] ' src={Dance} alt="hello" />
         <p className='text-bg absolute font-sans text-sm  bottom-[20px] uppercase font-bold left-[20px]'>IMG_054.JPG</p>
      </div>
        <Image className=' bottom-[30px] absolute left-[20px] mt-[20px]' src={About} alt="hello" />
        </div>
        <div className='  hidden bg-bg p-10  border-border xl:block   w-[60.7%] order-3'>
     <RevealWrapper origin='bottom' duration={900}>  <div className="flex  mb-[30px] items-center justify-centr   gap-3"> <div className=' bg-text text-bg inline-block  rounded-full p-1  hover:scale-105 cursor-pointer duration-300 '><a className=' gap-1 flex items-center'><Image src={logo} alt='logo'/>I love development, very much</a> </div>
        <Image src={Twikle} alt='start'/></div></RevealWrapper>
...
<RevealWrapper origin='bottom' duration={1300}>
    ...
    <div className='flex'> <RevealWrapper origin='bottom' duration={1400}> <div className='text-text duration-500 hover:bg-text hover:text-bg border-[1px]   text-sm inline-block mt-[30px] p-3 rounded-full'>
       ...
       <RevealWrapper origin='bottom' duration={1400}> <div className='text-text cursor-pointer duration-500 hover:bg-text hover:text-bg border-[1px] mx-3 text-sm inline-block mt-[30px] p-3 rounded-full'>
