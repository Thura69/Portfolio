...
const FirstFrame = () => {
  ...
  return (
      ...
      <div className='w-full flex fixed items-center  bg-bg z-[100]   top-0 left-0 right-0  justify-center h-[50px] xs:h-[50px] lg:h-[60px] mid:h-[35px]'> <Frames className='w-[3%] xs:w-[5%] mid:w-[7%] md:w-[5%] lg:w-[3.05%]'/>
